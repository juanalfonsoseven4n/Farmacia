...
<html:form target="_self" action="/Opcion.do?method=saveAdd">
		...
		<tr>
			...
			<table border="0" cellpadding="0" cellspacing="1" width="100%" >
				...
				<logic:messagesPresent>
                    ...
                    <td class="formulario"><bean:message key="opcion.field.nombre" />
					...
					<td ><html:text styleClass="selText"  property="nombre" maxlength="30"></html:text>
								...
								<tr class="navoff" onmouseover="className='navon'" onmouseout="className='navoff'">
                    <td class="formulario"><bean:message key="opcion.field.descripcion" />
                    
                    </td>
					<td width="5"></td>
					<td ><html:text styleClass="selText"  property="descripcion" maxlength="30"></html:text>
										</td>
				</tr>
							<tr >
