...
<script type="text/javascript">
	...
	, 	sobres
		...
		if(sobres!=''){
			eval("top.opener.document.getElementById('sobres').value = \'"+sobres+"\'")
		}else{
			eval("top.opener.document.getElementById('sobres').value = '0'")
		}
		if(precioventa!=''){
			eval("top.opener.document.getElementById('preccajas').value = \'"+precioventa+"\'")
		}else{
			eval("top.opener.document.getElementById('preccajas').value = '0'")
		}
		if(valor!=''){
			eval("top.opener.document.getElementById('precsobres').value = \'"+valor+"\'")
		}else{
			eval("top.opener.document.getElementById('precsobres').value = '0'")
		}
		eval("top.opener.document.getElementById('presentaciones').style.display=''")
		window.close();
	}   
</script>
							...
							<logic:iterate indexId="ind" id="producto" name="PRODUCTOS"
								...
								<tr class="navoff" onmouseover="className='navon'" onmouseout="className='navoff'">
									<td>
										...
										onclick="transfer(
																				'<bean:write name="producto" property="idproducto"	scope="page" />'
											...
											,  										'<bean:write name="producto" property="valor"	scope="page" format="#,##0.00"/>'
											,  										'<bean:write name="producto" property="precioventa"	scope="page" format="#,##0.00"/>'
											...
											,  										'<bean:write name="producto" property="caja"	scope="page" />'
											,  										'<bean:write name="producto" property="sobre"	scope="page" />'
											 										);" />
									</td>
