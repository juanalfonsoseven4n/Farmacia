...
import com.farmacia.form.OpcperForm;
import com.farmacia.pojo.IFarmacia;
import com.ibatis.common.util.PaginatedList;



public class OpcperAction extends ASpeedyAction {
	...
	public ActionForward list(ActionMapping mapping, ActionForm form,
		...
		Collection opcpers = iFarmacia.obtenerOpcpers();
		PaginatedList pList=(PaginatedList)opcpers;
		HttpSession session = request.getSession();
		session.setAttribute("OPCPERS", opcpers);
		session.setAttribute("stringpag",getStringPage(pList,"OPCPERS","opcperForm","tolist"));
	...
	public ActionForward add(ActionMapping mapping, ActionForm form,
			HttpServletRequest request,	HttpServletResponse response)
			throws java.lang.Exception {
		OpcperForm forma = (OpcperForm) form;
		forma.clearStrings();
	...
	public ActionForward saveAdd(ActionMapping mapping, ActionForm form,
		...
		IServiceLocator locator = new ServiceLocator();
		IFarmacia iFarmacia = locator.getFarmacia();
		Opcper opcper = new Opcper();
							forma.setIdperfil(request.getParameter("campoperfil"));
					forma.setIdopcion(request.getParameter("campoopcion"));
					forma.setIdopcper("0");
							BeanUtils.copyProperties(opcper, forma);
		iFarmacia.insertarOpcper(opcper);
	...
	public ActionForward edit(ActionMapping mapping, ActionForm form,
		...
		IServiceLocator locator = new ServiceLocator();
		IFarmacia iFarmacia = locator.getFarmacia();
		Opcper buscar = new Opcper();
		
				buscar.setIdopcper(new java.math.BigDecimal(request.getParameter("idopcper")));
		
		Opcper opcper = iFarmacia.obtenerOpcperPorId(buscar);
		
		OpcperForm forma = (OpcperForm) form;
		BeanUtils.copyProperties(forma,opcper);
	...
	public ActionForward saveEdit(ActionMapping mapping, ActionForm form,
		...
		Opcper opcper = new Opcper();
					...
					forma.setIdopcion(request.getParameter("campoopcion"));
							BeanUtils.copyProperties(opcper, forma);
		iFarmacia.actualizarOpcper(opcper);
	...
	public ActionForward saveDelete(ActionMapping mapping, ActionForm form,
		...
		Opcper opcper = new Opcper();
		BeanUtils.copyProperties(opcper, forma);
		iFarmacia.eliminarOpcper(opcper);
