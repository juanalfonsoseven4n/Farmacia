...
<html:form target="_self" action="/Categoria.do?method=listPopup">
<script type="text/javascript">
	...
	, 	descripcion
		...
		eval("top.opener.document.getElementById('campocategoria').value = \'"+idcategoria+"\'")
		eval("top.opener.document.getElementById('desccategoria').value = \'"+nombre+"\'")
		window.close();
	}   
</script>
							...
							<logic:iterate indexId="ind" id="categoria" name="LABORATORIOS"
								...
								<tr class="navoff" onmouseover="className='navon'" onmouseout="className='navoff'">
									<td>
										...
										onclick="transfer(
																				'<bean:write name="categoria" property="idcategoria"	scope="page" />'
											,  										'<bean:write name="categoria" property="nombre"	scope="page" />'
											,  										'<bean:write name="categoria" property="descripcion"	scope="page" />'
											 										);" />
										</td>
