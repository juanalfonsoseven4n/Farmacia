...
<html:form target="_self" action="/Usuario.do?method=saveEdit">
<script type="text/javascript">
	...
	<table border="0" cellpadding="0" cellspacing="0" width=90% align="center">
		...
		<tr>
			...
			<table border="0" cellpadding="0" cellspacing="1" width="100%" >
                    ...
                    <td class="formulario"><bean:message key="usuario.field.idusuario" /><span class="requerido">&nbsp;*  &nbsp;</span>	</td>
					<td width="5"></td>
					<td ><html:text styleClass="selText"  property="idusuario"
 readonly="true" maxlength="11"></html:text>
									</td>
				</tr>
								<tr class="navoff" onmouseover="className='navon'" onmouseout="className='navoff'">
                    <td class="formulario"><bean:message key="usuario.field.nombre" /><span class="requerido">&nbsp;*  &nbsp;</span></td>
					<td width="5"></td>
 ...
 maxlength="30"></html:text>
								...
								<tr class="navoff" onmouseover="className='navon'" onmouseout="className='navoff'">
                    <td class="formulario"><bean:message key="usuario.field.descripcion" /><span class="requerido">&nbsp;*  &nbsp;</span></td>
					<td width="5"></td>
 ...
 maxlength="50"></html:text>
					...
					<td ><html:text styleClass="selText"  property="password" maxlength="10"></html:text>
						...
						<tr class="navoff" onmouseover="className='navon'" onmouseout="className='navoff'">
                    <td class="formulario"><bean:message key="usuario.field.idperfil" /><span class="requerido">&nbsp;*  &nbsp;</span>	
					...
					<td ><html:select property="idperfil" styleClass="sel">
							...
							<html:options  collection="perfLista" labelProperty="nombre" property="idperfil" />
									...
									<tr class="navoff" onmouseover="className='navon'" onmouseout="className='navoff'">
                    <td class="formulario"><bean:message key="usuario.field.idfarmacia" /><span class="requerido">&nbsp;*  &nbsp;</span>	
