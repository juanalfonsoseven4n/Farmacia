...
<html:form target="_self" action="/Provprod.do?method=saveEdit">
...
<script type="text/javascript">
		...
		<tr>
			...
			<table border="0" cellpadding="0" cellspacing="1" width="100%" >
				...
				<logic:messagesPresent>
                    ...
                    <td class="formulario"><bean:message key="provprod.field.idproducto" /></td>
					<td width="5"></td>
					<td ><html:text property="idproducto"
 maxlength="11"></html:text>
										</td>
				</tr>
								<tr class="navoff" onmouseover="className='navon'" onmouseout="className='navoff'">
                    <td class="formulario"><bean:message key="provprod.field.idprovprod" /></td>
					<td width="5"></td>
					<td ><html:text property="idprovprod"
 readonly="true" maxlength="11"></html:text>
					<span class="requerido">&nbsp;*  &nbsp;</span>					</td>
				</tr>
								<tr class="navoff" onmouseover="className='navon'" onmouseout="className='navoff'">
                    <td class="formulario"><bean:message key="provprod.field.valor" /></td>
					<td width="5"></td>
					<td ><html:text property="valor"
 maxlength="13"></html:text>
		 ...
		 <td class="formulario"><bean:message key="provprod.field.idproveedor" /></td>
					<td width="5"></td>
					<td ><html:hidden property="idproveedor" ></html:hidden>
				...
				<tr  align="center" class="titulos">
					<td colspan="3" ><html:submit styleClass="boton"
						...
						id="Regresar" onclick="cambioAction(this.form,'<%=request.getContextPath()%>/Provprod.do?method=list');" 
