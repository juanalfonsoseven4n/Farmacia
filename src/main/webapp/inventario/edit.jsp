...
<html:form target="_self" action="/Inventario.do?method=saveEdit">
...
<script type="text/javascript">
		...
		<tr>
			...
			<table border="0" cellpadding="0" cellspacing="1" width="100%" >
				...
				<logic:messagesPresent>
					...
					<td width="5"></td>
					<td ><html:text styleClass="selText"  property="idinventario"
 readonly="true" maxlength="11"></html:text>
					...
					<td width="5"></td>
					<td ><html:text styleClass="selText"  property="cantidad"
 maxlength="11"></html:text>
					...
					<td width="5"></td>
					<td ><html:text styleClass="selText"   property="fechaexpir" size="10" maxlength="10" onfocus="this.select()" 
				   ...
				   alt="Obtener Fecha" onclick="return showCalendar('fechaexpir', 'y/mm/dd');">
					...
					<td width="5"></td>
					<td ><html:text styleClass="selText"  property="fechaing" size="10" maxlength="10" onfocus="this.select()" 
					   onblur="this.value=this.value.toUpperCase()" readonly="true"/>&nbsp;<IMG src="<%=request.getContextPath()%>/images/calendario.gif"
 ...
 maxlength="30"></html:text>
					...
					<td width="5"></td>
					<td ><html:text styleClass="selText"  property="preciocosto"
 maxlength="13"></html:text>
		 ...
		 <td class="formulario"><bean:message key="inventario.field.idproducto" /></td>
					<td width="5"></td>
					<td ><html:hidden property="idproducto" ></html:hidden>
				...
				<tr  align="center" class="titulos">
					<td colspan="3" ><html:submit styleClass="boton"
						...
						id="Regresar" onclick="cambioAction(this.form,'<%=request.getContextPath()%>/Inventario.do?method=list');" 
