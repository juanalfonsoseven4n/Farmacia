...
<html:form target="_self" action="/Producto.do?method=saveEdit">
	...
	<input type="hidden" name="pageSource" id="pageSource" value="toedit" />

	<table border="0" cellpadding="0" cellspacing="0" width=90% align="center">
		<tr width="90%">
			<td align="center" class="titulos"><bean:message key="producto.title.edit" /></td>
		</tr>
		...
		<tr>
			...
			<table border="0" cellpadding="0" cellspacing="1" width="100%">
				...
				<tr class="navoff" onmouseover="className='navon'" onmouseout="className='navoff'">
					...
					<td width="5"></td>
					<td><html:text styleClass="selText" property="idproducto" readonly="true" maxlength="11"></html:text> <span class="requerido">&nbsp;*
					&nbsp;</span></td>
				</tr>
				<tr class="navoff" onmouseover="className='navon'" onmouseout="className='navoff'">
				...
				<tr class="navoff" onmouseover="className='navon'" onmouseout="className='navoff'">
					...
					<td width="5"></td>
					<td><html:text styleClass="selNum" property="iva" maxlength="5"></html:text></td>
				</tr>
				<tr class="navoff" onmouseover="className='navon'" onmouseout="className='navoff'" style="display: none;">
					...
					<td width="5"></td>
					<td><html:text styleClass="selText" property="valorunit" maxlength="13"></html:text></td>
				</tr>
				<tr class="navoff" onmouseover="className='navon'" onmouseout="className='navoff'">
				...
				<tr class="navoff" onmouseover="className='navon'" onmouseout="className='navoff'">
					...
					<td width="5"></td>
					<td><html:text styleClass="selNum" property="sobre" maxlength="5"></html:text></td>
				</tr>
				<tr class="navoff" onmouseover="className='navon'" onmouseout="className='navoff'">
				...
				<tr class="navoff" onmouseover="className='navon'" onmouseout="className='navoff'">
					...
					<td width="5"></td>
					<td><html:hidden property="idfamilia"></html:hidden> 
				...
				<tr class="navoff" onmouseover="className='navon'" onmouseout="className='navoff'">
					...
					<td width="5"></td>
					<td><html:text styleClass="selText" property="comentarios" maxlength="500"></html:text></td>
				</tr>
				<tr class="navoff" onmouseover="className='navon'" onmouseout="className='navoff'">
					<td class="formulario"><bean:message key="producto.field.indicaciones" /></td>
					<td width="5"></td>
					<td><html:text styleClass="selText" property="indicaciones" maxlength="500"></html:text></td>
				</tr>
				...
				<tr align="center" class="titulos">
					<td colspan="3"><html:button styleClass="boton" onclick="enviar(this.form)" property="Editar">
						<bean:message key="label.global.editar" />
					</html:button> <input type="button" class="boton" id="Regresar" onclick="cambioAction(this.form,'<%=request.getContextPath()%>/Producto.do?method=list');"
						value="<bean:message key="label.global.regresar" />"></td>
				</tr>
			</table>
			</td>
		</tr>
