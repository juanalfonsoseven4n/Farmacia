...
<html:form target="_self" action="/Gasto.do?method=saveEdit">
...
<script type="text/javascript">
	...
	<table border="0" cellpadding="0" cellspacing="0" width=90% align="center">
		...
		<tr>
			...
			<table border="0" cellpadding="0" cellspacing="1" width="100%" >
					...
					<td width="5"></td>
					<td ><html:text styleClass="selText"  property="idgasto"
 ...
 maxlength="30"></html:text>
					...
					<td width="5"></td>
					<td ><html:text styleClass="selText"  property="fecha" size="10" maxlength="10" onfocus="this.select()" 
