...
<html:form target="_self" action="/Cliente.do?method=saveAdd">
		...
		<tr>
			...
			<table border="0" cellpadding="0" cellspacing="1" width="100%" >
				...
				<logic:messagesPresent>
                    ...
                    <td class="formulario"><bean:message key="cliente.field.nombre" />
					...
					<span class="requerido">&nbsp;*  &nbsp;</span>					</td>
								...
								<tr class="navoff" onmouseover="className='navon'" onmouseout="className='navoff'">
                    <td class="formulario"><bean:message key="cliente.field.apellido" />
                    
                    </td>
					<td width="5"></td>
					<td ><html:text styleClass="selText"  property="apellido" maxlength="30"></html:text>
										</td>
				</tr>
								<tr class="navoff" onmouseover="className='navon'" onmouseout="className='navoff'">
                    <td class="formulario"><bean:message key="cliente.field.direccion" />
					...
					<td ><html:text styleClass="selText"  property="direccion" maxlength="40"></html:text>
								...
								<tr class="navoff" onmouseover="className='navon'" onmouseout="className='navoff'">
                    <td class="formulario"><bean:message key="cliente.field.telefono" />
                    
                    </td>
					<td width="5"></td>
					<td ><html:text styleClass="selText"  property="telefono" maxlength="50"></html:text>
										</td>
				</tr>
								<tr class="navoff" onmouseover="className='navon'" onmouseout="className='navoff'">
                    <td class="formulario"><bean:message key="cliente.field.mail" />
					...
					<td ><html:text styleClass="selText"  property="mail" maxlength="30"></html:text>
								...
								<tr class="navoff" onmouseover="className='navon'" onmouseout="className='navoff'">
                    <td class="formulario"><bean:message key="cliente.field.cedula" />
                    
                    </td>
					<td width="5"></td>
					<td ><html:text styleClass="selText"  property="cedula" maxlength="16"></html:text>
										</td>
				</tr>
				<tr class="navoff" onmouseover="className='navon'" onmouseout="className='navoff'">
