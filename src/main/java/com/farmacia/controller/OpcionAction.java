...
import com.farmacia.form.OpcionForm;
import com.farmacia.pojo.IFarmacia;
import com.ibatis.common.util.PaginatedList;



public class OpcionAction extends ASpeedyAction {
	...
	public ActionForward list(ActionMapping mapping, ActionForm form,
		...
		Collection opcions = iFarmacia.obtenerOpcions();
		PaginatedList pList=(PaginatedList)opcions;
		HttpSession session = request.getSession();
		session.setAttribute("OPCIONS", opcions);
		session.setAttribute("stringpag",getStringPage(pList,"OPCIONS","opcionForm","tolist"));
	...
	public ActionForward listPopup(ActionMapping mapping, ActionForm form,
		...
		HttpSession session = request.getSession();
		session.setAttribute("OPCIONS", opcions);
		session.setAttribute("stringpag",getStringPage(pList,"OPCIONS","opcionForm","tolistpopup"));
	...
	public ActionForward add(ActionMapping mapping, ActionForm form,
			HttpServletRequest request,	HttpServletResponse response)
			throws java.lang.Exception {
		OpcionForm forma = (OpcionForm) form;
		forma.clearStrings();
	...
	public ActionForward saveAdd(ActionMapping mapping, ActionForm form,
		...
		forma.setIdopcion("0");
				BeanUtils.copyProperties(opcion, forma);
		iFarmacia.insertarOpcion(opcion);
	...
	public ActionForward edit(ActionMapping mapping, ActionForm form,
		...
		IServiceLocator locator = new ServiceLocator();
		IFarmacia iFarmacia = locator.getFarmacia();
		Opcion buscar = new Opcion();
		
				buscar.setIdopcion(new java.math.BigDecimal(request.getParameter("idopcion")));
		
		Opcion opcion = iFarmacia.obtenerOpcionPorId(buscar);
		
		OpcionForm forma = (OpcionForm) form;
		BeanUtils.copyProperties(forma,opcion);
	...
	public ActionForward saveEdit(ActionMapping mapping, ActionForm form,
		...
		Opcion opcion = new Opcion();
				BeanUtils.copyProperties(opcion, forma);
		iFarmacia.actualizarOpcion(opcion);
	...
	public ActionForward saveDelete(ActionMapping mapping, ActionForm form,
		...
		Opcion opcion = new Opcion();
		BeanUtils.copyProperties(opcion, forma);
		iFarmacia.eliminarOpcion(opcion);
