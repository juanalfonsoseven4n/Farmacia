...
<html:form target="_self" action="/Producto.do?method=saveDelete">
			...
			<table border="0" cellpadding="0" cellspacing="1" width="100%" align="center">
				...
				<tr class="navoff" onmouseover="className='navon'" onmouseout="className='navoff'" align="center">
					...
					<td ><html:hidden property="iva" write="true"></html:hidden></td>
								...
								<tr class="navoff" onmouseover="className='navon'" onmouseout="className='navoff'" align="center" style="display: none;">
				...
				<tr  align="center" class="titulos">
					...
					<input type="button" class="boton"
						id="Regresar" onclick="cambioAction(this.form,'<%=request.getContextPath()%>/Producto.do?method=list');" 
