...
<logic:notEmpty name="RECVENTA" scope="session">
	<bean:define id="recventa" name="RECVENTA" ></bean:define>
	<table border="0" cellpadding="0" cellspacing="3" width=100% align="center" class="recibo">
		...
		<logic:present name="recventa" property="codigo">
		<logic:notEqual value="0" name="recventa" property="codigo">
		<tr >
			<td align="right" colspan="4" style="padding-right: 30px"><bean:message key="titulo.factura" /> <bean:write name="recventa" property="codigo" format="#########0"/></td>
		</tr>
		...
		<logic:notEmpty name="recventa" property="detalles">
				
			<logic:iterate indexId="ind" id="detventa" name="recventa" property="detalles"
		...
		<tr style="display: none;">
            <td align="right" colspan="4"><bean:message key="venta.field.iva" /> : 
            $<bean:write name="recventa" property="iva" format="#,##0"/></td>
		</tr>
		<tr >
            <td align="right" colspan="4"><bean:message key="venta.field.valortotal" /> : 
            $<bean:write name="recventa" property="valortotal" format="#,##0"/></td>
		</tr>
		<tr >
            <td align="center" colspan="4">---------------------------</td>
		</tr>
		...
		<tr>
	        ...
	        <bean:write name="recventa" property="fechaFormated"/> 				
				<br><br> 
...
<logic:empty name="RECVENTA" scope="session">
