...
<html:form target="_self" action="/Categoria.do?method=saveAdd">
	...
	<table border="0" cellpadding="0" cellspacing="0" width=90% align="center">
		...
		<tr>
			...
			<table border="0" cellpadding="0" cellspacing="1" width="100%" >
                    ...
                    <td class="formulario"><bean:message key="categoria.field.nombre" />
					...
					<td ><html:text property="nombre" maxlength="50"></html:text>
								...
								<tr class="navoff" onmouseover="className='navon'" onmouseout="className='navoff'">
                    <td class="formulario"><bean:message key="categoria.field.descripcion" />
