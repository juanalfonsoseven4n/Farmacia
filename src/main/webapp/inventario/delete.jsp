...
<html:form target="_self" action="/Inventario.do?method=saveDelete">
	...
	<table border="0" cellpadding="0" cellspacing="0" width=90% align="center">
		<tr width="90%">
			<td align="center" class="titulos" ><bean:message
				key="inventario.title.delete" /></td>
		</tr>
			...
			<table border="0" cellpadding="0" cellspacing="1" width="100%" align="center">
				...
				<logic:messagesPresent>
					...
					<td ><html:hidden property="idinventario" write="true"></html:hidden></td>
								...
								<tr style="display: none;" class="navoff" onmouseover="className='navon'" onmouseout="className='navoff'" align="center">
