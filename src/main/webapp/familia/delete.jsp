...
<html:form target="_self" action="/Familia.do?method=saveDelete">
		...
		<tr>
			...
			<table border="0" cellpadding="0" cellspacing="1" width="100%" align="center">
				...
				<logic:messagesPresent>
                    ...
                    <td class="formulario"><bean:message key="familia.field.nombre" /></td>
					<td width="5"></td>
					<td ><html:hidden property="nombre" write="true"></html:hidden></td>
				</tr>
								<tr class="navoff" onmouseover="className='navon'" onmouseout="className='navoff'" align="center">
                    <td class="formulario"><bean:message key="familia.field.idfamilia" /></td>
					<td width="5"></td>
					<td ><html:hidden property="idfamilia" write="true"></html:hidden></td>
				</tr>
								<tr class="navoff" onmouseover="className='navon'" onmouseout="className='navoff'" align="center">
                    <td class="formulario"><bean:message key="familia.field.descripcion" /></td>
					<td width="5"></td>
				...
				<tr  align="center" class="titulos">
					...
					<input type="button" class="boton"
						id="Regresar" onclick="cambioAction(this.form,'<%=request.getContextPath()%>/Familia.do?method=list');" 
