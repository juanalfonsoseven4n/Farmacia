...
<html:form target="_self" action="/Venta.do?method=saveAdd">
		...
		<tr>
			...
			<table border="0" cellpadding="0" cellspacing="1" width="100%" >
				...
				<logic:messagesPresent>
                    ...
                    <td class="formulario"><bean:message key="venta.field.fecha" />
                    
                    </td>
					<td width="5"></td>
					<td ><html:text styleClass="selText"  property="fecha" maxlength="9"></html:text>
										</td>
				</tr>
								<tr class="navoff" onmouseover="className='navon'" onmouseout="className='navoff'">
                    <td class="formulario"><bean:message key="venta.field.valortotal" />
                    
                    </td>
					<td width="5"></td>
					<td ><html:text styleClass="selText"  property="valortotal" maxlength="13"></html:text>
					<span class="requerido">&nbsp;*  &nbsp;</span>					</td>
				</tr>
								<tr class="navoff" onmouseover="className='navon'" onmouseout="className='navoff'">
                    <td class="formulario"><bean:message key="venta.field.iva" />
					...
					<td ><html:text styleClass="selText"  property="iva" maxlength="13"></html:text>
								...
								<tr class="navoff" onmouseover="className='navon'" onmouseout="className='navoff'">
                    <td class="formulario"><bean:message key="venta.field.codigo" />
					...
					<td ><html:text styleClass="selText"  property="codigo" maxlength="30"></html:text>
								...
								<tr class="navoff" onmouseover="className='navon'" onmouseout="className='navoff'">
                    <td class="formulario"><bean:message key="venta.field.valor" />
					...
					<td ><html:text styleClass="selText"  property="valor" maxlength="13"></html:text>
								...
								<tr class="navoff" onmouseover="className='navon'" onmouseout="className='navoff'">
                    <td class="formulario"><bean:message key="venta.field.hora" />
                    
                    </td>
					<td width="5"></td>
					<td ><html:text styleClass="selText"  property="hora" maxlength="7"></html:text>
										</td>
				</tr>
		 ...
		 <td class="formulario"><bean:message key="venta.field.idcliente" /></td>
					<td width="5"></td>
					<td ><html:hidden property="idcliente" value="0"></html:hidden>
		 ...
		 <td class="formulario"><bean:message key="venta.field.idmedico" /></td>
					<td width="5"></td>
					<td ><html:hidden property="idmedico" value="0"></html:hidden>
