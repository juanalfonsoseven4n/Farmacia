...
<html:form target="_self" action="/Laboratorio.do?method=saveDelete">
	...
	<table border="0" cellpadding="0" cellspacing="0" width=90% align="center">
		<tr width="90%">
			<td align="center" class="titulos" ><bean:message
				key="laboratorio.title.delete" /></td>
		</tr>
		...
		<tr>
			...
			<table border="0" cellpadding="0" cellspacing="1" width="100%" align="center">
				...
				<logic:messagesPresent>
                    ...
                    <td class="formulario"><bean:message key="laboratorio.field.idlaboratorio" /></td>
					<td width="5"></td>
					<td ><html:hidden property="idlaboratorio" write="true"></html:hidden></td>
				</tr>
								<tr class="navoff" onmouseover="className='navon'" onmouseout="className='navoff'" align="center">
                    <td class="formulario"><bean:message key="laboratorio.field.nombre" /></td>
					<td width="5"></td>
					<td ><html:hidden property="nombre" write="true"></html:hidden></td>
				</tr>
								<tr class="navoff" onmouseover="className='navon'" onmouseout="className='navoff'" align="center">
                    <td class="formulario"><bean:message key="laboratorio.field.descripcion" /></td>
					<td width="5"></td>
				...
				<tr  align="center" class="titulos">
					...
					<input type="button" class="boton"
						id="Regresar" onclick="cambioAction(this.form,'<%=request.getContextPath()%>/Laboratorio.do?method=list');" 
