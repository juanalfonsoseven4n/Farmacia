...
<html:form target="_self" action="/Detventa.do?method=saveEdit">
...
<script type="text/javascript">
		...
		<tr>
			...
			<table border="0" cellpadding="0" cellspacing="1" width="100%" >
				...
				<logic:messagesPresent>
					...
					<td width="5"></td>
					<td ><html:text styleClass="selText"  property="iddetventa"
 ...
 maxlength="13"></html:text>
					...
					<td width="5"></td>
					<td ><html:text styleClass="selText"  property="valorunit"
 maxlength="13"></html:text>
										</td>
				</tr>
		 ...
		 <td class="formulario"><bean:message key="detventa.field.idventa" /></td>
					<td width="5"></td>
					<td ><html:hidden property="idventa" ></html:hidden>
		 ...
		 <td class="formulario"><bean:message key="detventa.field.idproducto" /></td>
				...
				<tr  align="center" class="titulos">
					<td colspan="3" ><html:submit styleClass="boton"
						...
						id="Regresar" onclick="cambioAction(this.form,'<%=request.getContextPath()%>/Detventa.do?method=list');" 
