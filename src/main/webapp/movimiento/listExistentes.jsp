...
<section class="main">
	...
	<html:hidden property="strutsOrderby" />
		...
		<div class="contBus">
			...
			<span class="spanName" ><bean:message key="producto.field.idcategoria" /></span>
					...
					<div class="tableCont">
						<table cellspacing="0">
							...
							<tr>
								...
								<th width="6%"><bean:message key="movimiento.field.cantidadSobre" /></th>
								<th width="6%"><bean:message key="producto.field.precioventa" /></th>
								<th width="6%"><bean:message key="producto.field.valor" /></th>
